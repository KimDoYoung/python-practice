...
"""
모듈 설명: 
    - LS증권API를 사용함에 있어서 Client의 모델을 LS API의 모델로 변환하는 유틸리티
주요 기능:
    - order_to_cspat00601_Request : 주문 요청 모델로 변환
    - modify_order_to_cspat00701_Request : 주문정정 요청 모델로 변환
    - cancel_order_to_cspat00801_Request : 주문취소 요청 모델로 변환
    - acct_history_to_CDPCQ04700_Request : 계좌별 거래내역 조회 요청 모델로 변환
    - fulfill_to_t0425_Request : 주문체결내역 조회 요청 모델로 변환
    - fulfill_api_to_cspaq13700_Request : 주문체결내역 조회 요청 모델로 변환
    - high_item_to_T1441_Request : 등락율 상위 요청 모델로 변환
    - high_item_to_T1452_Request : 거래량 상위 요청 모델로 변환
    - high_item_to_T1466_Request : 전일동시간대비거래급증 요청 모델로 변환
    - high_item_to_T1481_Request : 시간외등락율상위 요청 모델로 변환
    - high_item_to_T1482_Request : 시간외거래량상위 요청 모델로 변환
    - high_item_to_T1489_Request : 예상체결량상위조회 요청 모델로 변환
    - high_item_to_T1492_Request : 단일가예상등락율상위 요청 모델로 변환
    - high_item_to_T1463_Request : 거래대금상위 요청 모델로 변환
