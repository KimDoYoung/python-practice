...
def result():
    data = {'company_info': {'종목명': '노브랜드', '진행상황': '공모주', '시장구분': '코스닥', '종목코드': '145170', '업종': '의복,의복액세서리 및 모피제품 제조업', '대표자': '이상규', '본점소재지': '서울특별시 송파구 오금로46길 49 (가락동) 노브랜드', '홈페이지': '', '최대주주': '김기홍 42%', 
    ...
    '희망공모가액': '8,700 ~ 11,000원', '확정공모가': '14,000원', '공모금액': '16,800 (백만원)', '주간사': '삼성증권'}, 'schedule_info': {'공모청약일': '2024.05.13 \xa0~ \xa0 2024.05.14', '납입일': '2024.05.17', '환불일': '2024.05.17', '상장일': '2024.05.23', 'IR일자': '2024.05.03', '기관경쟁률': '1075.61:1', 
