...
class Ifi01CompanyApi(Base):
    ...
    ifi01_company_api_id = Column(Numeric, primary_key=True, comment='AssetAPI고객사정보ID(PK)')
    ifi01_company_id = Column(Numeric, nullable=False, comment='회사ID(sys01_company_id)')
    ifi01_config_api_id = Column(Numeric, nullable=False, comment='API관리ID(ifi91_config_api_id)')
