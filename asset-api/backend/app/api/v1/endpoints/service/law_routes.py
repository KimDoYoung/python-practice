...
async def r011(
    ...
    service = LawService(db)
    # 포함시켜야할 필드들 추출 
    field_mapping = await service.field_mapping('LAW011')
    # law10에서 데이터 추출
    ...
    resp = await service.run_r011(req)
    resp_dict = resp.model_dump()
